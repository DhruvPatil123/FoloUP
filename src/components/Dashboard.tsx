...
import { 
  ...
  Send, Palette, History, ShieldAlert, BarChart3
} from 'lucide-react';
...
export default function Dashboard({ 
  ...
  const [recruiterEmail, setRecruiterEmail] = useState(() => {
    return localStorage.getItem('recruiter_email') || 'recruiter@foloup.ai';
  });
  const [recruiterPhone, setRecruiterPhone] = useState(() => {
    return localStorage.getItem('recruiter_phone') || '+1 (555) 700-1122';
  });
  const [recruiterCompany, setRecruiterCompany] = useState(() => {
    return localStorage.getItem('recruiter_company') || 'FoloUp Sandbox Technologies';
  });
  ...
  const [brandConfig, setBrandConfig] = useState<any>({
    companyName: 'FoloUp Sandbox Technologies',
    themeColor: '#4f46e5',
    gdprText: 'By proceeding with this vocal-screening session, you explicitly agree that FoloUp systems can record your voice, analyze speaking patterns (WPM, latency, filler word frequency) and query generative AI models to score your replies. All processing is strictly GDPR-compliant.',
    emailProvider: 'simulated',
    emailApiKey: '',
    senderEmail: 'onboarding@resend.dev',
    recruiterAlertEmail: 'recruiter@foloup.ai'
  });
        ...
        <div className="space-y-8">
          ...
          <div className="flex justify-between items-start flex-wrap gap-4 bg-slate-900 text-white p-8 rounded-3xl relative overflow-hidden shadow-xl border border-slate-800">
            ...
            <div className="space-y-2 z-10 p-1">
              ...
              <h1 className="text-3xl font-extrabold text-white tracking-tight">FoloUp Hiring Workspace</h1>
          ...
          <div className="lg:col-span-4 space-y-6">
            ...
            <div className="bg-slate-50 border border-slate-100 p-5 rounded-3xl space-y-2">
              ...
              <p className="text-[11px] text-slate-500 leading-relaxed font-light">
                Candidate dispatch creates a specialized, pre-scored profile inside the FoloUp engine. Use the resulting link on the Candidate screen of the portal to simulate a real interview callback immediately.
              </p>
            </div>
          </div>
              ...
              <div className="border-t border-slate-100 pt-5 space-y-4">
                ...
                <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                  <div className="space-y-1">
                    ...
                    <input
                      type="email"
                      placeholder="recruiter@foloup.ai"
            ...
            <div className="bg-white border border-slate-100 rounded-3xl p-6 shadow-sm space-y-4">
              ...
              <div className="border border-slate-200/65 rounded-2xl overflow-hidden shadow-xs">
                ...
                <div className="p-4 flex items-center justify-between border-b border-indigo-50/50" style={{ backgroundColor: brandConfig.themeColor }}>
                  <span className="text-white text-xs font-extrabold tracking-tight font-display">{brandConfig.companyName}</span>
                ...
                <button
                  ...
                  onClick={() => {
                    ...
                    if (isEditingProfile) {
                      ...
                      setRecruiterEmail(localStorage.getItem('recruiter_email') || 'recruiter@foloup.ai');
                      setRecruiterPhone(localStorage.getItem('recruiter_phone') || '+1 (555) 700-1122');
                      setRecruiterCompany(localStorage.getItem('recruiter_company') || 'FoloUp Sandbox Technologies');
                    }
                  }}
